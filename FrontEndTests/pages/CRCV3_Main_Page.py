...
class CRCV3MainPage(BasePage):
    ...
    Campaigns_Planning_list = PageElement(By.XPATH, "//ul[@class='nhsuk-grid-row nhsuk-card-group']/li")
    ...
    Better_Health_Local_Authority_Tier_2 = PageElement(By.LINK_TEXT, "Better Health Local Authority Tier 2 Adult Weight Management Programme")
    ...
    C4L_related_website_link = PageElement(By.LINK_TEXT, "www.nhs.uk/healthier-families")
    ...
    Abdominal_and_urological_symptoms_of_cancer = PageElement(By.LINK_TEXT, "Abdominal and Urological Symptoms of Cancer")
    Accessible_campaign_posters = PageElement(By.LINK_TEXT, "Accessible campaign posters")
    ...
    Social_Media_calendar_assets = PageElement(By.LINK_TEXT, "Social media calendar and assets")
    ...
    Communications_toolkit = PageElement(By.LINK_TEXT, "Communications toolkit")
    ...
    Help_us_help_you_link = PageElement(By.LINK_TEXT, "Help Us, Help You")
    BH_Start4Life_link = PageElement(By.LINK_TEXT, "Better Health Start for Life Introducing Solid Foods")
    Help_us_help_you_Landing = PageElement(By.XPATH, "//h1[text()='Help Us, Help You']")
    BH_Start4Life_Landing = PageElement(By.TAG_NAME, "h1")
    Accessing_NHS_maternity_services = PageElement(By.LINK_TEXT, "Accessing NHS Maternity Services")
    Accessing_NHS_mental_health_services = PageElement(By.LINK_TEXT, "Accessing NHS Mental Health Services")
    ...
    target_audience = PageElement(By.XPATH, "//span[text()[normalize-space()='Target audience']]")
    Topics_Expanded = PageElement(By.ID, "TOPIC")
    target_audience_Expanded = PageElement(By.XPATH, "//label[text()[normalize-space()='Adults']]")
    Language = PageElement(By.XPATH, "//span[text()[normalize-space()='Language']]")
    Language_Expanded = PageElement(By.ID, "LANGUAGE")
    Profession_Expanded = PageElement(By.XPATH, "//label[text()[normalize-space()='Commercial partner']]")
    Alternative_format_Expanded = PageElement(By.XPATH, "//label[text()[normalize-space()='Audio']]")
    Profession = PageElement(By.XPATH, "//span[text()[normalize-space()='Profession']]")
    Alternative_format = PageElement(By.XPATH, "//span[text()[normalize-space()='Alternative format']]")
    Resource_type = PageElement(By.XPATH, "//span[text()[normalize-space()='Resource type']]")
    Resource_type_Expanded = PageElement(By.XPATH, "//label[text()[normalize-space()='Brand assets and guidelines']]")
    ...
    Address_error_list = PageElement(By.XPATH, "//ul[@class='govuk-list govuk-error-summary__list']//li")
    Empty_error = PageElement(By.XPATH, "//ul[@class='govuk-list govuk-error-summary__list']//a[1]")
    filter_by_topics_list = PageElement(By.XPATH, "//div[@class='campaign-filters']/ul/li")
    ...
    invalid_resource_errors_list = PageElement(By.XPATH, "//ul[@class='govuk-list govuk-error-summary__list']//a[1]")
    ...
    order_confirmation_message = PageElement(By.XPATH, "//h1[text()='Your order has been placed']")
    account_page_landing = PageElement(By.XPATH, "//strong[text()='Manage your account']")
    ...
    show_all_sections_expand = PageElement(By.CLASS_NAME, "govuk-accordion__show-all-text")
    ...
    def click_resource(self):
        ...
        assert_that(self.interrogate.is_image_visible_by_checking_src(self.Resource_Search_label),
                    equal_to(True), "Search")

    def click_campaign_planning(self):
        self.interact.click_element(self.click_campaign_planning_tab)
        assert_that(self.interrogate.is_element_visible(self.Campaign_Planning_label),
                    equal_to(True), "Campaign Planning tab is not opening")

    def Click_About(self):
        self.interact.click_element(self.click_about_tab)
        assert_that(self.interrogate.is_element_visible(self.about_label),
                    equal_to(True), "about tab is not opening")

    def Click_OHID_link(self):
        assert_that(right_click_link(self, "Office for Health Improvement and Disparities (OHID)"),
                    contains_string("https://www.gov.uk/government/organisations/office-for-health-improvement-and-disparities/about"),
    ...
    def what_guides_us_expand_collapse(self):
        ...
        assert_that(self.interrogate.is_element_visible(self.hide_we_are_locally_driven),
                    equal_to(True), "we are locally driven isn't expanded")
        self.interact.click_element(self.we_are_locally_driven_expand)
        self.interact.click_element(self.we_are_prototype_learn_expand)
        assert_that(self.interrogate.is_element_visible(self.hide_we_are_prototype),
                    equal_to(True), "we are prototype learn isn't expanded")
        self.interact.click_element(self.we_are_prototype_learn_expand)


    def select_resource(self):
        self.interact.click_element(self.select_resource_add)
        assert_that(self.interrogate.is_element_visible(self.A4_poster_resource), equal_to(True), "A4 Poster title is not displayed")
    ...
    def click_account(self):
        ...
        assert_that(self.interrogate.is_element_visible(self.account_page_landing),
                    equal_to(True), "account page is not displayed")
        sleep(5)

    def account_links(self):
        self.interact.click_element(self.account_details)
        assert_that(self.interrogate.is_element_visible(self.account_details_page),
                equal_to(True), "account details page is not displayed")
        self.interact.click_element(self.Newsletter_preferences)
        assert_that(self.interrogate.is_element_visible(self.Newsletter_preferences_page),
                    equal_to(True), "Newsletter preferences page is not displayed")
        self.interact.click_element(self.Order_history)
        assert_that(self.interrogate.is_element_visible(self.Order_history_page),
                    equal_to(True), "Order history page is not displayed")
        sleep(5)
    ...
    def password_reset(self):
        ...
        assert_that(self.interrogate.is_element_visible(self.Password_reset_page),
                    equal_to(True), "Password reset page is not displayed")
    ...
    def order_confirmation(self):
        assert_that(self.interrogate.get_attribute(self.order_confirmation_message, "innerHTML"), equal_to("Your order has been placed"), "placing order message is not displayed")
    ...
    def CRCV3_Mainpage_labels(self):
        assert_that(self.interrogate.is_image_visible_by_checking_src(self.Covid_label), equal_to(True), "Covid label is not displayed")
        assert_that(self.interrogate.is_image_visible_by_checking_src(self.Latest_updates_label), equal_to(True), "Latest updates label is not displayed")
    ...
    def Latest_Updates_links(self, option):
        ...
        if option == "Start4Life":
            ...
            assert_that(self.interrogate.is_element_visible(self.Cervical_Screening_landing), equal_to(True), "Cervical Screening page not loaded")
            #self.driver.back()
    ...
    def Help_us_help_you_Campaigns(self, Campaigns):
        if Campaigns == "Accessing NHS maternity services":
            ...
            assert_that(self.interrogate.is_element_visible(self.Accessing_NHS_mental_health_services_Landing),
            ...
            assert_that(self.interrogate.is_element_visible(self.Childhood_vaccination_2022_Landing),
    ...
    def BH_Start4Life(self):
        ...
        assert_that(self.interrogate.is_element_visible(self.BH_Start4Life_Landing),
    ...
    def expand_collapse_filter_results(self):
        ...
        assert_that(self.interrogate.is_element_visible(self.Topics_Expanded),
                    equal_to(True), "Topics link isn't expanded")
        self.interact.click_element(self.topics)
        self.interact.click_element(self.target_audience)
        assert_that(self.interrogate.is_element_visible(self.target_audience_Expanded),
                    equal_to(True), "target audience link isn't expanded")
        self.interact.click_element(self.target_audience)
        self.interact.click_element(self.Language)
        assert_that(self.interrogate.is_element_visible(self.Language_Expanded),
                    equal_to(True), "Language link isn't expanded")
        self.interact.click_element(self.Language)
        self.interact.click_element(self.Profession)
        assert_that(self.interrogate.is_element_visible(self.Profession_Expanded),
                    equal_to(True), "Profession link isn't expanded")
        self.interact.click_element(self.Profession)
        self.interact.click_element(self.Alternative_format)
        assert_that(self.interrogate.is_element_visible(self.Alternative_format_Expanded),
                    equal_to(True), "Alternative format link isn't expanded")
        self.interact.click_element(self.Alternative_format)
        self.interact.click_element(self.Resource_type)
        assert_that(self.interrogate.is_element_visible(self.Resource_type_Expanded),
                    equal_to(True), "Resource type link isn't expanded")
        self.interact.click_element(self.Resource_type)
