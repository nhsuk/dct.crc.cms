...
def load_tobacco_landing_page(context):
    ...
    if cookie_banner_displayed is True:
        ...
        assert_that(context.landing_page.CRCV3_landing_message(), equal_to(CRCV3_Mainpage), "CRCV3 page not loaded")
        sleep(5)
...
@Step("Verify Campaign Resource Centre lable, Covid advices resources and latest updates labels are available")
...
@Step("I click on Sign in button Sign in page loaded with Email_address and and password")
