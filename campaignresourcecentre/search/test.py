...
class TestAzureSearchBackend(TestCase):
    ...
    def test_get_filters_from_facets(self):
        ...
        facets_filter = self.azure_search._get_filters_from_facets(
            facets_queryset
        )
    ...
    def test_get_filters_from_fields(self):
        ...
        facets_filter = self.azure_search._get_filters_from_fields(
            fields_queryset
        )
        self.assertEqual(expected, facets_filter)
    ...
    def test_build_query_string_from_filters(self):
        ...
        facets_filter = self.azure_search._build_query_string_from_filters(
            filters
        )
        self.assertEqual(expected, facets_filter)
