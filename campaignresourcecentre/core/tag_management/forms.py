...
class ManageTagsForm(forms.Form):
    active_tab = forms.CharField(widget=forms.HiddenInput(), required=False, initial='remove')
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['source_page'].queryset = Page.objects.type(CampaignPage, ResourcePage).all()
