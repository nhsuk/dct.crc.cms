...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.CharField(blank=True, help_text='Enter the text for the link. This is required for external URLs. If an internal page is chosen and this field is blank the page title will be shown', max_length=255),
        ),
