locals {
  ...
  postgresql_server_resource_id = var.environment == "development" ? module.nhsuk[0].postgresql_server_id : module.nhsuk-integration[0].postgresql_server_id
  postgresql_server_name        = var.environment == "development" ? module.nhsuk[0].postgresql_server_name : module.nhsuk-integration[0].postgresql_server_name
  postgresql_resource_group     = var.environment == "development" ? module.nhsuk[0].postgresql_resource_group : module.nhsuk-integration[0].postgresql_resource_group
